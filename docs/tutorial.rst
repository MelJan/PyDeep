...
.. toctree::
   ...
   AE on MNIST<tutorials/AE_MNIST.rst>
...
For an introduction to Restricted Boltzmann machines especially for Gaussian input variables you can have a look into my `master's theses <https://www.ini.rub.de/PEOPLE/wiskott/Reprints/Melchior-2012-MasterThesis-RBMs.pdf>`_

A good introduction into several machine learning topics with exercises and video lectures can be found in the here `course Material <https://www.ini.rub.de/PEOPLE/wiskott/Teaching/Material/index.html>`_ .
